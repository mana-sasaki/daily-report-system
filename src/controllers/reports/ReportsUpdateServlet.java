...
public class ReportsUpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (_token != null && _token.equals(request.getSession().getId())) {
            ...
            System.out.println("report_id ：" + request.getSession().getAttribute("report_id"));
            ...
            if (errors.size() > 0) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/reports/edot.jsp");
