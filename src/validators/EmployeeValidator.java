...
public class EmployeeValidator {
    ...
    public static List<String> validate(Employee e, Boolean codeDuplicateCheckFlag, Boolean passswordCheckFlag) {
        ...
        String password_error = validatePassword(e.getPassword(), passswordCheckFlag);
